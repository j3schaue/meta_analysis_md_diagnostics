...
Using and extending naniar and visdat R's packages we demonstrate how visualizations typically used with datasets outside of meta-analysis can be adapted to the realities of meta-analytic data (Tierney, 2019)

3.1 Whole-data plots

Aggregation plots are a useful tool for identifying in which variables observations are missing and how many. We can visualize overall missingness using vis_dat and vis_miss functions from the visdat R package. 
...
Naniar package provides a different approach to visualizing overall missingness. Function gg_miss_var, clearly identifies variables with a greater number or percentage of missing cases. 

(Insert plot 3)

Plot 3 presents variables in order of number/percentage of missing cases. For this particular dataset, there are 10 variables with at least 10% of missing cases. 
