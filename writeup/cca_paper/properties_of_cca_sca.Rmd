...
In general, it will be impossible to know whether a selection model is correctly specified, but the formulation in \@ref(eq:r-loglinear) offers a few important advantages. 
...
The second term in \@ref(eq:bias-sca) captures the bias due to ignoring missing observations in $X_{iS}$.
...
Further, the issues of multicollinearity and confounding in meta-regression, including those discussed by Lipsey @lipseyThoseConfoundedModerators2003, would suggest that omitting variables in a SCA are likely to induce bias.
