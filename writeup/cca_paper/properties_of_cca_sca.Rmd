...
While under model \@ref(cc-loglinear), this probability is a function of $T_i$ and $X_i$, we can intuit $H_1(0)$ loosely as a missingness rate in $X$ among effects for which $X_i = 0$.
