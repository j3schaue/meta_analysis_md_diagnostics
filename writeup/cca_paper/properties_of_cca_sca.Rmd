...
\textcolor{blue}{[JL - If MNAR, then unbiased? I feel this is counter-intuitive?]}
...
First, the bias increases in $H_1(0)$, which is an approximation of the probability that the covariate $X_i$ among studies for which $X_i = 0$. 
