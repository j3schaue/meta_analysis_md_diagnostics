...
Ignoring missing data can potentially lead to biased estimates of parameters of interest [see @littleStatisticalAnalysisMissing2002; @grahamMissingData2012].
...
<!-- \textcolor{blue}{[JL - Why W and T have only $U$, without $S$?]} -->
<!-- \textcolor{orange}{[Does that make more sense?]} -->
<!-- \textcolor{blue}{[I think I understand. $U$ essentially has $X_S$ information.]} -->
...
It is possible to derive an approximation for $\delta_{ij}$ under certain conditions when the distribution of $R_i | T_i, X_i, v_i$ follows a log-linear model. 
...
Finally, is the selection model depends only on $v_i$ and $X_i$, but not $T_i$, then $R_i \perp T_i | (X_i, v_i)$, which would correspond to an MNAR mechanism.
...
<!-- \textcolor{orange}{I don't think that's right. $H(X)$ is really $H(X, \eta, \psi)$. You should be thinking of $H(X)$ more as the probability that $R_i = 0$ given $X_i$ and $\theta_i$ (and maybe even $v_i$, depending on the model).} -->
<!-- \textcolor{blue}{[Thank you. Checked!]} -->
...
<!-- \textcolor{orange}{Take the derivative of the bias wrt $\psi_2$, and you'll see that it depends on $\psi_1$. So, whether the bias is increasing or decreasing as a function of $\psi_2$ depends on the value (and sign) of $\psi_1$. More important, the sign of the derivative depends on the sign of $\psi_1$.} -->
<!-- \textcolor{blue}{Thanks. Checked.} -->
...
<!-- \textcolor{blue}{Sure. I commented out those.} -->
...
<!-- \textcolor{blue}{[This is in Way 4 below.]} -->
...
<!-- \textcolor{blue}{[Way3 - Figure \@ref(fig:bias_density_b0), \@ref(fig:bias_density_b1)]} -->


<!-- \begin{figure} -->
<!-- \begin{center} -->
<!-- \includegraphics[width = .8\textwidth]{../../writeup/cca_paper/graphics/p_int_m.pdf} -->
<!-- \end{center} -->
...
<!-- \begin{figure} -->
<!-- \begin{center} -->
<!-- \includegraphics[width = .8\textwidth]{../../writeup/cca_paper/graphics/p_b1_m.pdf} -->
<!-- \end{center} -->
...
<!-- \textcolor{blue}{[Way4 - Figure \@ref(fig:bias_box)]} -->
