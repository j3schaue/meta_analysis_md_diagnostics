...
\textcolor{orange}{No. H(X) is really $H(X, \eta, \psi)$. You should be thinking of $H(X)$ more as the probability that $R_i = 0$ given $X_i$ and $\theta_i$ (and maybe even $v_i$, depending on the model).}
