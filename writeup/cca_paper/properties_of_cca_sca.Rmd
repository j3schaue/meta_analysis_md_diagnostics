...
A common concern in meta-regression is that models may not be able to account for all relevant covariates, either due to sample size constraints or because because some covariates were not observed [@lipseyThoseConfoundedModerators2003].
