...
\textcolor{orange}{Take the derivative of the bias wrt $\psi_2$, and you'll see that it depends on $\psi_1$. So, whether the bias is increasing or decreasing as a function of $\psi_2$ depends on the value (and sign) of $\psi_1$.}
