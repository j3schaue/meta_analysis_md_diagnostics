...
\textcolor{blue}{[JL - How much detail do you want to have in here? I think we can just say we assume independent effect size in this study and not provide the detailed model formulation with dependent effect sizes. If necessary, we may include the formulation in Appendix instead. 
...
\textcolor{blue}{[JL - I think the notations in this paragraph are not very clear to me with $S$ and $E$ indices and also introducing $U(S)$. Can we simplify this?]}
...
\textcolor{blue}{[JL - If MNAR, then unbiased?]}
...
\end{equation} 
\textcolor{blue}{[JL -I guess W_C is missing above?]}
where 
\[
...
\textcolor{blue}{[*JL - Does it indicate $R_i \perp v_i | T_i, X_i$ ?*]}
