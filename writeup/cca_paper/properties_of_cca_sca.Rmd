...
bibliography: ../addons/cca_references_alt.json
---
...
\begin{figure}
\begin{center}
\includegraphics[width = .8\textwidth]{../../writeup/cca_paper/graphics/Boxplot.pdf}
\end{center}
\caption{Bias of intercept and slope [ADD MORE DESCRIPTION]}
\label{fig:bias_box}
\end{figure}
