...
That is, out of all of the $k \times p$ cells in the data, 8.2% are missing values.
...
data <- adt_data[!myvars]
gg_summary_covariate_miss(data)
```
...
Figure \@ref(fig:figs2) displays the percent of each column missing.
