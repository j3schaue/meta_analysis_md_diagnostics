...
The fact that not every study reports the information required to run a meta-regression means that many meta-analyses face missing data problems.
Issues with missing data are not new. 
There is a vast literature on methods for handling missing data in primary studies, as well as work on related issues in meta-analysis.
...
Understanding what and how much data is missing, and how problematic that is, is crucial for contextualizing the results of a meta-analysis.
In addition, a key assumption of analyses involving missing data is that the analyst has some idea about why data is missing.
...
"Missing data" could also refer to information that couldn’t be extracted from a completed study by a meta-analyst. 
...
This is a common problem in meta-analysis and one that can limit the accuracy of any statistical inferences.
