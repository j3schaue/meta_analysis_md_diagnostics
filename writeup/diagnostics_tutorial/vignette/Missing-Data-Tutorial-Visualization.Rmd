...
The purpose of this vignette is to demonstrate used to conduct an exploratory missingness analysis (EMA) as described by [AUTHORS].
...
The `visdat` library visualizes the entire data frame at once.
