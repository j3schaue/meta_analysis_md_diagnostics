...
abstract: |
  | OBJECTIVES: In this tutorial, we examine methods for exploring missingness in a dataset in ways that can help identify the sources and extent of missingness, as well as clarify gaps in evidence. 
  | METHODS: Using raw data from Tanner et al. (2016), we demonstrate the use of exploratory missingness analysis (EMA) including techniques for numerical summaries and visual displays of missing data. 
  ...
  | CONCLUSION: We would advocate meta-analysts employ some form of EMA as they encounter missing data.
---
